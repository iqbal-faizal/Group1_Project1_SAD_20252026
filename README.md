...
```mermaid
graph TD
A[Project Planner<br>Muhammad Iqbal bin Faizal]
A --> B[System Tester<br>Ahmad AzrulAmin bin Shamsuri]
A --> C[System Designer<br>Aleesya Daania binti Mohd Farid]
A --> D[System Analyst<br>Annchalee Anon]
A --> E[System Analyst<br>Natasha Athirah binti Abdullah]
```
...
![Organizational Chart](Organizational_Chart.png)
